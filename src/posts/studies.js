export default {
  ...
  content: `
    ...
    nothing more. Ok, one hobby (music), et pas plus. not a video-game friki,
    ...
    (TCCM — an amazing master if you like theoretical chemistry). i wasn’t sure
    ...
    to do a PhD, because… why not? phd time. And apparently not satisfied with
